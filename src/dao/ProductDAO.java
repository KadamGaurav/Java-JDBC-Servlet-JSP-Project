...
public class ProductDAO 
{
	...
	//error in code
	public boolean updateProduct(Product productObj)throws Exception
	{
		PreparedStatement psmt=conn.prepareStatement("update Product set productname = ?,price = ?,productdesc = ?,stock = ?,category = ?,supplier = ? where productid = ?");
		...
		psmt.setString(5, productObj.getCategory());
		psmt.setString(6, productObj.getSupplier());
		psmt.setInt(7, productObj.getProductId());
